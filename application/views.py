...
def adminhome():
    ...
    expenses_user = Expenses.query.filter_by(user=current_user.staffid).all()

    total_amount = 0
    for expense in expenses_user:
        total_amount += expense.amount

    return render_template("adminhome.html", expenses=expenses_user, name_user="current_user.name",
